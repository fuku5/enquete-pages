- 以下をよく読んで、「おためし」→「本番」と進んでください。

# 設定
- 環境にはつねに、りんご2つ、梨2つとエージェントが存在します。

- りんご、梨、エージェントは毎エピソード開始時にランダムに出現します。
  - エージェントはどこに出現するか選べません。
...
- あなたは下図のように、ある固定視点から見えるエージェントの動きを、コマ送りで見ていると思ってください。
  - (全体のフィールドに比べて、あなたの見える範囲が狭いことがわかると思います。)
  
 <br> <img src="imgs/human-perspective.png" width="45%">
 <br> <img src="imgs/whole.png" width="45%">
...
- まずは、1エピソードだけ[おためし](test.html)
  - 終わったらこの画面に戻ってきます。
- おためしがおわったら、[本番](test2.html)
